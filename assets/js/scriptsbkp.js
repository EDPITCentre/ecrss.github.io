...
$(document).ready(function(){
	...
	$('#blockdes').on('change',function(){
		...
		else if(document.getElementById("availv").value=='Fully' && grantv=='Fully'){ 
			document.getElementById("reason").style.display = 'none';
		}
		else{
			document.getElementById("avail").style.display = 'none';
		...
		else if(availv=='Fully' && document.getElementById("grantv").value=='Fully'){ 
		//	alert(document.getElementById("grantv").value);
			document.getElementById("reason").style.display = 'none';
		}
		else{
			document.getElementById("reason").style.display = 'block';
